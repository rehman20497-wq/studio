                ...
                <div className="relative w-full mx-auto grid grid-cols-10 items-center gap-[5%]">
                    <div className="col-span-3">
                        <div className="relative w-48 h-48 mx-auto">
                            <div className="absolute left-4 top-8 animate-float-1">
                                <FloatingIcon>
                            ...
                            <div className="absolute right-4 top-12 animate-float-2">
                                <FloatingIcon>
                            ...
                            <div className="absolute right-8 bottom-8 animate-float-3">
                                <FloatingIcon>
                    ...
                    <div className="col-span-7 pl-[5%] mr-[10%]">
                        <StatCard
