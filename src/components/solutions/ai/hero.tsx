...
export default function Hero() {
  ...
  return (
    <motion.section
      ref={ref}
      className="relative min-h-screen flex items-center bg-[#ebdaff] rounded-t-3xl mx-[4%] mt-4 overflow-hidden"
      ...
      <div className="container mx-auto 2xl:max-w-[90%] px-[6%] py-12 grid md:grid-cols-2 gap-8 items-center">
        ...
        >
          <motion.div custom="right" variants={itemVariants}>
            <Cpu className="w-10 h-10 text-purple-800" />
          </motion.div>
          <motion.h1
            custom="top"
  ...
  sm:text-heroMd
  lg:text-hero font-normal text-black leading-[72.5px] mt-4"
          >
            AI Solutions
          </motion.h1>
          <motion.p
  ...
  sm:text-bodyMd
  lg:text-bodylg text-black max-w-lg leading-[28.7px]"
          >
            Harness the power of Artificial Intelligence to drive innovation and efficiency. Our AI solutions help you automate tasks, gain insights, and create smarter products.
          </motion.p>
          <motion.div
            custom="bottom"
            variants={itemVariants}
