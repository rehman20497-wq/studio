...
export default function FeaturedGuideSectionss() {
  ...
  sm:text-bodyyMd
  lg:text-bodyylg text-black" variants={textItemVariants}>
...
>
          ...
          <div
            className="absolute -top-24 -right-2 rounded-2xl overflow-hidden bg-[#e64628]"
            style={{
              width: '90%',
              height: '95%',
