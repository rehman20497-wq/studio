...
export default function CustomerSupportSection() {
  ...
  lg:text-bodylg text-black"
        >
We provide enterprise-grade communication solutions that simplify collaboration, enhance customer engagement, and enable businesses to operate smoothly and scale without disruption.        </motion.p>
