...
>
  ...
  <motion.div
    ...
    className="hidden md:block absolute -top-4 left-[24%] sm:left-[31%] lg:left-[34%] pointer-events-none z-10"
  >
    <Image
      src="/aw.png"
      alt="Arrow"
  ...
  lg:text-bodylg text-black"
        >
         Scalable, secure, and cost-efficient cloud solutions designed to support growth, improve performance, and simplify IT operations.
        </motion.p>
