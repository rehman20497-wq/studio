...
export default function RiskFreeTrialsss() {
  ...
  return (
    ...
    >
      {/* Vertical Peach Gradient Layers */}
<div className="absolute inset-0 flex">
  <div className="flex-[1] bg-[#ffe3dd]" />
  <div className="flex-[1.3] bg-[#ffcfc6]" />
  <div className="flex-[2.5] bg-[#fd9c8a]" />   {/* main brand color */}
  <div className="flex-[1.5] bg-[#ffc1b6]" />
  <div className="flex-[1] bg-[#fff0ec]" />
</div>
