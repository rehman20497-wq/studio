...
export default function RiskFreeTrials() {
  ...
  return (
    ...
    >
      ...
      {/* Vertical Green Layers */}
      <div className="absolute inset-0 flex">
        <div className="flex-[1] bg-[#e6fad9]" />
        <div className="flex-[1.3] bg-[#c9f5a6]" />
        <div className="flex-[2.5] bg-[#95e66e]" />
        <div className="flex-[1.5] bg-[#a8ed86]" />
        <div className="flex-[1] bg-[#ddf7cc]" />
      </div>
