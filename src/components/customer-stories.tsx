...
const TestimonialCard = ({ testimonial, featured = false }: { testimonial: (typeof testimonials)[0], featured?: boolean }) => (
  <div
    className={cn(
      'flex-shrink-0 w-[420px] h-[460px] rounded-2xl p-8 flex flex-col font-poppins transition-colors duration-300 group',
      featured
        ? 'bg-cyan-100'
        : 'bg-cream-light hover:bg-cyan-100'
    )}
  >
...
export default function CustomerStories() {
  ...
  return (
    <section ref={ref} className="bg-cream-light py-24 overflow-hidden">
      <motion.div
        className="relative"
